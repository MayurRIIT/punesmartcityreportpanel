...
@Component({
  selector: 'app-helpsupportreport',
  templateUrl: './helpsupportreport.component.html',
  styleUrls: ['./helpsupportreport.component.scss'],
})
export class HelpsupportreportComponent implements OnInit {
  ...
  loadDashboardData(){
      ...
      this.loading = true;
      this.userService.getHelpSupportQuestionsReport(gradeId,mediumId,this.viewtype,this.selectfromdate,this.selecttodate).subscribe(response => {
  ...
  saveAnswer(){
    ...
    this.userService.addHelpSupportAnswer(_userObj).subscribe((response) => {
          ...
          if(response.responseCode == 200){
            ...
            this.alertService.success("Support Query updated successfully");
