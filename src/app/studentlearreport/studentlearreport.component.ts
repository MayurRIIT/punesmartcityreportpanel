...
@Component({
  selector: 'app-studentlearreport',
  templateUrl: './studentlearreport.component.html',
  styleUrls: ['./studentlearreport.component.scss'],
})
export class StudentlearreportComponent implements OnInit {
