...
@Component({
  selector: 'app-view-scholarship-response',
  templateUrl: './view-scholarship-response.component.html',
  styleUrls: ['./view-scholarship-response.component.scss'],
})
export class ViewScholarshipResponseComponent implements OnInit {
  ...
  getTestPaper() {
    this.userService.getTestPaperscholarship(this.scholarshipId,this.userType,localStorage.getItem("id"))
      .subscribe((res: any) => {
  ...
  loadDashboardData(){
    ...
    this.loading = true;
    this.userService.getscholarshipStudent(this.scholarshipId,testPaperId,this.userType,localStorage.getItem("id")).subscribe(response => {

          console.log(response);  
          if(response.responseCode == 200){
              this.datalist = response.result.scholarshipPaperResponseData;
              this.loading = false;     
  ...
  evalutePaper(iTestPaperResponseId){
    ...
    this.router.navigate(['/home/evaluate-scholarship-response'], { queryParams: { scholarshipId: this.scholarshipId , testPaperResponseId: iTestPaperResponseId, gradeId : this.gradeId, mediumId : this.mediumId } });
